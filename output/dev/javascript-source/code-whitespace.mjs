...
const splitLines = (text) => text.replace(NEWLINE, "\n").split("\n");
...
const removeIndent = (lines, indent) => {
  if (!indent) {
    return lines;
  }
...
export const normalizeCodeWhitespace = (textContent = "") => {
  if (!textContent) {
    return "";
  }
...
export const normalizeCodeNode = (node) => {
  if (!node) {
    return;
  }
